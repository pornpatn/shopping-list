...
import {
    createTag as createItem,
    updateTag as updateItem,
    deleteTag as deleteItem,
    selectTags as selectItems,
    NEW_TAG_TEMPLATE as NEW_ITEM_TEMPLATE,
} from '../../../../store/tagSlice';
...
function TagSettings() {
    ...
    const handleItemClick = (id) => {
        const selectedTag = entities.find(item => item.id === id);
        if (selectedTag) {
